...
#ifndef DAVID303TTL_SYNTH_ENGINE_ENGINE_H
#define DAVID303TTL_SYNTH_ENGINE_ENGINE_H
...
struct Engine
{
    ...
    struct VMResponder
    {
        ...
        void terminateVoice(Voice *voice) { DEBUG_LOG_UNIMPL; }
            ...
            for (int vc = 0; vc < ct; ++vc)
            {
                if (ibuf[vc].instruction !=
                    sst::voicemanager::VoiceInitInstructionsEntry<
                        david303ttl::synthtemplate::Engine::VMConfig>::Instruction::SKIP)
                {
        ...
        void setNoteExpression(Voice *v, int32_t e, double val) { DEBUG_LOG_UNIMPL; }
        ...
        void setPolyphonicAftertouch(Voice *v, int8_t a) { DEBUG_LOG_UNIMPL; }

        void setVoiceMIDIMPEChannelPitchBend(Voice *v, uint16_t b) { DEBUG_LOG_UNIMPL; }
        void setVoiceMIDIMPEChannelPressure(Voice *v, int8_t p) { DEBUG_LOG_UNIMPL; }
        void setVoiceMIDIMPETimbre(Voice *v, int8_t t) { DEBUG_LOG_UNIMPL; }
    };
