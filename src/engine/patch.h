...
#ifndef DAVID303TTL_SYNTH_ENGINE_PATCH_H
#define DAVID303TTL_SYNTH_ENGINE_PATCH_H
...
struct Patch : pats::PatchBase<Patch, Param>
{
    ...
    struct SynthNode
    {
        ...
        std::string name() const { return "SynthTemplate"; }
